...
![1](D:\web-bianc\finalproject\1.png)
...
![7](D:\web-bianc\finalproject\7.png)

#### 2、用户注册前端（register.html)

<img src="D:\web-bianc\finalproject\5.png" alt="5" style="zoom: 67%;" />
...
<img src="D:\web-bianc\finalproject\6.png" alt="6" style="zoom:67%;" />
...
![8](D:\web-bianc\finalproject\8.png)
...
![9](D:\web-bianc\finalproject\9.png)
...
<img src="D:\web-bianc\finalproject\2.png" alt="3" style="zoom:60%;" />

<img src="D:\web-bianc\finalproject\3.png" alt="4" style="zoom:60%;" />

（2）时间热度分析图表（以东方财富网查询 “中国” 为例）：

<img src="D:\web-bianc\finalproject\4.png" alt="2" style="zoom: 40%;" />

这次实验中，尝试使用饼状图来展示内容查询词的热度分析，结果如下图所示：

<img src="D:\web-bianc\finalproject\19.png" alt="19" style="zoom: 60%;" />
...
<img src="D:\web-bianc\finalproject\16.png" alt="16" style="zoom:67%;" />
...
![27](D:\web-bianc\finalproject\27.png)
...
![17](D:\web-bianc\finalproject\17.png)
...
![18](D:\web-bianc\finalproject\18.png)
...
<img src="D:\web-bianc\finalproject\20.png" alt="20" style="zoom: 67%;" />
...
<img src="D:\web-bianc\finalproject\21.png" alt="21" style="zoom:50%;" />
...
<img src="D:\web-bianc\finalproject\22.png" alt="22" style="zoom:50%;" />

在分词查询时，虽然返回的一些新闻与查询字段匹配度不是很高，但其召回率较高，提供了很多相关的新闻供用户进行参考

![23](D:\web-bianc\finalproject\23.png)
...
<img src="D:\web-bianc\finalproject\24.png" alt="24" style="zoom:67%;" />
...
<img src="D:\web-bianc\finalproject\25.png" alt="25" style="zoom:67%;" />
...
![26](D:\web-bianc\finalproject\26.png)
...
### 七、实验中遇到的问题以及需要注意的点
 ...
 1. 在使用POST方法进行前后端传参时，发现页面始终没有反应，原以为是使用POST方法存在问题，所以在检查POST方法上花了很多时间，后来通过前端发现是未引用jquery库jquery.min.js文件的原因
    ...
    <img src="D:\web-bianc\finalproject\10.png" alt="10" style="zoom:80%;" />

    <img src="D:\web-bianc\finalproject\11.png" alt="11" style="zoom: 80%;" />

    <img src="D:\web-bianc\finalproject\web4.png" alt="web4" style="zoom: 80%;" />

 2. 在前端处理POST方法返回的数据时，误以为数据为JSON类型，用JSON方式进行解析后，产生以下报错信息

    ![13](D:\web-bianc\finalproject\13.png)

    ![12](D:\web-bianc\finalproject\12.png)

    后来才发现数据为object类型，解析数据的方式出现问题

    ![15](D:\web-bianc\finalproject\15.png)

    ![14](D:\web-bianc\finalproject\14.png)
